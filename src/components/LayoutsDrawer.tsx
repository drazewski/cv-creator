...
export default function LayoutsDrawer() {
  ...
  const layouts = useMemo<LayoutCard[]>(() => [
    {
      id: 'classic',
      label: t('layouts.classicLabel'),
      description: t('layouts.classicDescription'),
      preview: <ClassicPreview />,
    },
    {
      id: 'us-single',
      label: t('layouts.usSingleLabel'),
      description: t('layouts.usSingleDescription'),
  ...
  return (
    <div className="layouts-drawer">
      <p className="layouts-drawer__hint">{t('layouts.hint')}</p>
