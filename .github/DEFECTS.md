...
| 11 | Default parts of CV, like for example country name in contact or experience (word "Present") should translate to the language of the CV | ❌ Not Fixed | Requires implementation of localization for default CV parts |
